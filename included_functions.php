...
<?php //this code is reused from CSCI 475
	...
	function new_header($name="Ainsley", $urlLink="https://turing.cs.olemiss.edu/~aggordon") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~aggordon/".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";	
	...
	function new_footer($name="Ainsley Gordon"){
